...
class CommonController extends Controller
{
    ...
    public function actionChange(){
        ...
        if($this->request->isAjax){
            ...
            AddLogController::addSysLog(AddLogController::account,AddLogController::edit,'个人档案设定修改密码');
    ...
    public function actionIndex(){
        if($this->request->isAjax){
            ...
            $list->andWhere(['=','a.admin',$this->root_id]);
            $count = $list->count();
            $list = $list->select(['a.id','a.username','a.realname','a.sex','a.phone','a.email','a.addtime','a.address','a.position','a.weixin','r.role'])
    ...
    public function actionRole(){
        ...
        if($this->request->isPost){
            ...
            AddLogController::addSysLog(AddLogController::admin_user,AddLogController::edit,'修改管理员角色,管理员 id:'.$admin_id);
    ...
    public function actionEdit(){
        ...
        if($this->request->isPost){
            ...
            if($flag_error && !$username){
                ...
                $account = Account::find()->where(['username'=>$username,'admin'=>$this->root_id])->andWhere(['!=','id',$id])->one();
            ...
            if ($flag_error) {
                ...
                $res = $info->save();
                if($res){
                    AddLogController::addSysLog(AddLogController::account,AddLogController::edit,'编辑账号,账号为:'.$username);
    ...
    public function actionAdd(){
        ...
        if($this->request->isPost){
            ...
            if($flag_error && !$username){
                ...
                $account = Account::findOne(['username'=>$username,'admin'=>$this->root_id]);
                if($flag_error && $account){
                    $flag_error = false;
                    $this->withErrors('该账户名称已经存在!');
                }
            ...
            if ($flag_error) {
                ...
                $res = $info->save();
                if($res){
                    AddLogController::addSysLog(AddLogController::account,AddLogController::add,'新增账号,账号为:'.$username);
    ...
    public function actionDel(){
        if($this->request->isAjax){
            ...
            if($model && $model->delete()){
                AddLogController::addSysLog(AddLogController::account,AddLogController::delete,'刪除账户,账户为:'.$username);
