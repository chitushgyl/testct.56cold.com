...
?>
    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto" >
            ...
            <div class="layui-inline">
                <input class="layui-input" name="keyword" id="keyword" autocomplete="off" placeholder="请输入车牌号/归属公司" style="width: 320px">
            </div>
    ...
    <script type="text/html" id="state">
        {{# if(d.status==1){ }}
        <a class="layui-btn layui-btn-sm">审核中</a>
        {{# }else if(d.status == 2){ }}
    ...
    <script>
        layui.use(['layer','table','form'],function () {
            ...
            var dataTable = table.render({
                elem: '#dataTable'
                ,height: 800
                ,url: "<?php echo route('admin.car.index'); ?>" //数据接口
                // ,response:{
                //     dataName:'list',
                //     countName:'counts'
                // }
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'carnumber', title: '车牌号', align:'center',width:300}
                    ,{field: 'control', title: '温控', align:'center',width:250}
                    ,{field: 'driver_name', title: '姓名/电话', align:'center',width:250,toolbar:'#mobile'}
                    ,{field: 'board_time', title: '初始上牌日期', align:'center',width:100}
                    ,{field: 'check_time', title: '验车日期', align:'center',width:100}
                    ,{field: 'group_name', title: '归属公司', align:'center',width:250}
                    ,{field: 'status', title: '状态', align:'center',width:150,toolbar: '#state'}
            ...
            table.on('tool(dataTable)', function(obj){ //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'del'){
                    ...
                    location.href = '/admin/car/view?id='+data.id;
                }
            });
            function reload(){
