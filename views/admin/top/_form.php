...
<div class="layui-form-item">
    <label for="" class="layui-form-label">头部页面</label>
    <div class="layui-input-block">
        <input class="layui-input" type="text" name="url" value="<?php echo $info['url']?$info['url']:'';?>" placeholder="如：order" >
    </div>
</div>
...
<div class="layui-form-item">
    <div class="layui-input-block">
        ...
        <a href="<?php echo route('admin.top.index','pid='.$pid);?>" class="layui-btn"  >返 回</a>
    </div>
</div>
