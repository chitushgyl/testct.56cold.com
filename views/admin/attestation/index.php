...
?>
    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto" >
            ...
            <div class="layui-inline">
                <input class="layui-input" name="keyword" id="keyword" autocomplete="off" placeholder="归属公司" style="width: 320px">
            </div>
    ...
    <script type="text/html" id="state">
        {{# if(d.state==1){ }}
        <a class="layui-btn layui-btn-sm">认证中</a>
        {{# }else if(d.state == 2){ }}
    ...
    <script>
        layui.use(['layer','table','form'],function () {
            ...
            var dataTable = table.render({
                elem: '#dataTable'
                ,height: 800
                ,url: "<?php echo route('admin.attestation.index'); ?>" //数据接口
                // ,response:{
                //     dataName:'list',
                //     countName:'counts'
                // }
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'company_name', title: '归属公司', align:'center',width:250}
                ...
                if(layEvent === 'del'){
                    ...
                    layer.confirm('确认通过吗？', function(index){
                        $.ajax({
                            ...
                            url:"<?php echo route('admin.attestation.success'); ?>",
                            dataType:"JSON",
                            type:"POST",
                    ...
                    location.href = '/admin/attestation/view?id='+data.id;
                }
            });
            function reload(){
